...
class Client {
  ...
  async request(method, resource, type, body, attentions = [], opts = {}) {
  ...
  put(resource, type, params, attentions = [], opts = {}) {
    return this.request('PUT', resource, type, params, attentions, opts);
  }
